...
export default function ReferralPage() {
  return (
    <div className="referral-container">
      ...
      <p>
        If you&apos;re a care coordinator, GP or provider, you can refer a patient to Stride Podiatry using our secure online form or by
      ...
      <section className="form-section">
        ...
        <p>
          Complete and submit the secure form below. Your referral will be sent directly to Stride Podiatry through our online system.
        </p>
      ...
      <section className="form-section">
        ...
        <p>If you prefer, you can download and complete our PDF referral form instead.</p>
        <p>
          📄 <strong>Download:</strong> <a href="/referral-form.pdf">Stride Podiatry Referral Form (PDF)</a>
        </p>
        <p>
          📬 Email completed forms to: <a href="mailto:luke@stride-podiatry.com.au">luke@stride-podiatry.com.au</a>
        </p>
        <p>
